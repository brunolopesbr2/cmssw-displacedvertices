...
process.source.fileNames = ['file:///eos/user/b/brlopesd/dark_sectors/ntuples/ntuple_HeavyHiggsToLLPTo4mu_mH_800_mX_80_ctau_1_2017_privateMC_MINI_v5_generationHH.root']
#process.MessageLogger.cerr.FwkReport.reportEvery = 100
#process.options.wantSummary = True


tfileservice(process, '/eos/user/b/brlopesd/dark_sectors/histos/histo_ntuple_HeavyHiggsToLLPTo4mu_mH_800_mX_80_ctau_1_2017_privateMC_MINI_v5_generationHH.root')
