...
df = pd.read_csv("Higgs.txt", sep=" ", header=None)
...
test_name = 'HeavyHiggsToLLPTo4mu_mH_800_mX_80_ctau_1_2017_privateMC_MINI_v5_generationHH'
output_name = 'ntuples/ntuple_' + test_name + '.root'

process.out.fileName = output_name
dataset = 'miniaod' if settings.is_miniaod else 'main'

sample_files(process, 'HeavyHiggsToLLPTo4mu_mH_800_mX_80_ctau_1_2017_privateMC_MINI_v5_generationHH', dataset, 48)
