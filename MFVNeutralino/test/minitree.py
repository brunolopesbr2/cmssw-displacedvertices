...
if __name__ == '__main__' and hasattr(sys, 'argv') and 'submit' in sys.argv:
    ...
    if use_btag_triggers :
        ...
        samples = pick_samples(dataset, qcd=False, ttbar=False, all_signal=False, data=False, mfv_splitSUSY=False, mfv_HtoLLPto4j=False, mfv_HtoLLPto4b=False, mfv_ZprimetoLLPto4j=False, mfv_ZprimetoLLPto4b=False, StealthSHH=True, StealthSYY=False)
        pset_modifier = chain_modifiers(is_mc_modifier, per_sample_pileup_weights_modifier())
