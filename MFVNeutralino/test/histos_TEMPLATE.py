...
process.source.fileNames = ['file:///eos/user/b/brlopesd/dark_sectors/ntuples/INPUTNAME']
#process.MessageLogger.cerr.FwkReport.reportEvery = 100
#process.options.wantSummary = True


tfileservice(process, '/eos/user/b/brlopesd/dark_sectors/histos/histo_INPUTNAME')
