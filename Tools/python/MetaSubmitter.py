...
def pick_samples(dataset, both_years=False,
                 ...
                 span_signal=False, mfv_splitSUSY=False, mfv_HtoLLPto4j=False, mfv_HtoLLPto4b=False, mfv_ZprimetoLLPto4j=False, mfv_ZprimetoLLPto4b=False, StealthSHH=False, StealthSYY=False):

    if span_signal:
        print 'cannot use both span and all_signal, turning off the latter'
        all_signal = False

    argnames = 'qcd', 'ttbar', 'all_signal', 'span_signal', 'data', 'leptonic', 'bjet', 'mfv_splitSUSY', 'mfv_HtoLLPto4j', 'mfv_HtoLLPto4b', 'mfv_ZprimetoLLPto4j', 'mfv_ZprimetoLLPto4b', 'StealthSHH', 'StealthSYY'
